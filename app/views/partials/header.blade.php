...
@elseif(Auth::user()->role=='Pharmacy Manager')
     <!--========================================================
                             Pharmacy HEADER
    =========================================================-->
    <header id="header">
            ...
            <div class="container">
                <div class="row">
                    <div class="grid_12">
                        ...
                        <nav class="nav put-right">
                            <ul class="sf-menu">
                                <li @yield('current_pharmacy_home')><a href="/pharmacy_home">Home</a></li>
                                {{--<li @yield('current_services')><a href="/search_pmr">Medical Records</a></li>--}}
                                {{--<li @yield('current_about')><a href="/app_vitals">Vital Signs</a></li>--}}
                                {{--<li @yield('current_contacts')><a href="/appointments">Appointments</a></li>--}}
                                <li><a href="/logout">Logout</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="grid_12">
                        ...
                        <nav class="nav put-right">
                            <ul class="sf-menu">
                                <li @yield('current_nurse_home')><a href="/nurse_home">Home</a>
                                <ul>

                                 <li><a href="/view_patient">Health Sheet</a></li>
                                 <li><a href="/dutydays">Doctor Schedule</a></li>
                                 <li><a href="/cons">Consumptions</a></li>
                                ...
                                <li @yield('current_services')><a style="cursor: pointer">Health Sheet</a>
                                    <ul>
                                   <li @yield('current_services')><li><a href="/view_patient">View Health Sheet</a></li>

                                    </ul>
                                </li>
                                <li @yield('current_consumptions_patient')><a style="cursor: pointer">Consumptions</a>
                                    <ul>
                                        <li><a href="/cons">view Consumptions</a></li>
