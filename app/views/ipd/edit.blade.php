...
@section('content2')
	   ...
	   <center>
            ...
            {{ Form::model($patient, ['route' => ['ipd.update', $patient->id], 'method' => 'put' ,'style' => 'padding: 40px', 'id' => 'regForm'])}}
              ...
              <tr>
               ...
               <tr>
                                <td width="272" height="55"><label>Ward*</label> </td>
                                <td width="333">
                                     {{ Form::select('ward', $ward,array('id'=>'ward','name'=>'ward'))}}
                                </td>
                                </tr>
               <tr>
                              <td width="272" height="55"><label>Bed*</label> </td>
                              <td width="333">
                                  {{ Form::select('bed', $bed,array('id'=>'ward','name'=>'ward'))}}
                              </td>
                              </tr>
               <tr>
                              <td width="272" height="55"><label>Room*</label> </td>
                              <td width="333">
                                  {{ Form::input('text', 'room', null, array('required' => 'true')) }}
                              </td>
                              </tr>
              <!-- *******************************Extension***********************-->
