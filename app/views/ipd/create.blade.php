        ...
        @section('content2')
            ...
            <center>
                <div style="border: 4px solid #129894; width: 800px; border-radius: 10px; background-color: #EBEBEB">
                    ...
                    {{ Form::open(array('action' => 'IPDController@store', 'style' => 'padding: 40px', 'id' => 'regForm')) }}
                    <table width="621" height="720" border="0">
                        ...
                        <tr>
                            ...
                            <td width="333">
                                ...
                                {{ Form::select('ward',$ward, null ,array('id'=>'ward'))}}
                                {{--                                   <select id="ward"  name="ward" >{{{ $ward->ward_name}}}</select>--}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="333" id="bed_row">
                                ...
                                {{ Form::select('bed', $bed,null,array( 'id'=>'bed'))}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="333">
                                ...
                                {{ Form::select('room',  $room, null, array('placeholder' => 'select room','id' => 'room'))}}
                            </td>
                            {{--,array_merge([''=>'select room']--}}
                        </tr>  {{--<tr>--}}
                        {{--<td width="272" height="55"><label>Room no</label> </td>--}}
                        {{--<td width="333">--}}
                        {{--{{ Form::select('rooms', $room,array('id'=>'room'))}}                                  </td>--}}
                        {{--</tr>--}}
                 ...
                 &nbsp;     &nbsp;     &nbsp;
                  <label class="radio">
                      ...
                      Female</label>
                        ...
                        <input type="number" hidden="true" id="age" required="true"
                               value="{{{ Form::getValueAttribute('age', null) }}}" name="age">

                        <tr>
                            <td width="272" height="55"><label> City*</label></td>
                            <td width="333"><input type="text" id="city" required="true"
                                                   value="{{{ Form::getValueAttribute('city', null) }}}" name="city">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="333"><input type="text" id="address" required="true" name="address"
                                                   value="{{{ Form::getValueAttribute('address', null) }}}"></td>
                        </tr>
                        <tr>
                            <td width="272" height="55"><label> Mobile:</label></td>
                            <td width="333"><input type="text" placeholder="(0092)333-1234567" id="phone" name="phone"
                                                   value="{{{ Form::getValueAttribute('phone', null) }}}"></td>
                        </tr>
                        <tr>
                            <td width="272" height="55"><label> CNIC:</label></td>
                            <td width="333"><input type="text" id="cnic" name="cnic"
                                                   value="{{{ Form::getValueAttribute('cnic', null) }}}"></td>
                        </tr>
                        <tr>
                            <td width="272"><label>Additional Info:</label></td>
                            <td width="333"
                                height="200">{{ Form::textarea('note', null, array('rows' => '7', 'cols' => '20', 'placeholder' => 'note', "style" => "font-size: 1.2em; margin-top: 2px; resize: none;") ) }}</td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <center>
                                    <div class="btn-wrap">
                                        <a class="btn_3" href="javascript:document.getElementById('regForm').reset();"
                                           data-type="reset">Reset</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
