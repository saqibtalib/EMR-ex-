            ...
            {{ Form::model($employee, ['route' => ['employees.update', $employee->id], 'method' => 'put' ,'style' => 'padding: 40px', 'id' => 'regForm'])}}
              ...
              <tr>
                ...
                <td width="333"><select required name="role">
                  ...
                  <option @if($employee->role == "Pharmacy Manager") selected="true" @endif value="Pharmacy Manager">Pharmacy Manager</option>
                  <option @if($employee->role == "Nurse") selected="true" @endif value="Nurse">Nurse</option>
