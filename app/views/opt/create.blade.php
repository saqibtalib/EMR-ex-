        ...
        @section('content2')
            ...
            <center>
                <div style="border: 4px solid #129894; width: 800px; border-radius: 10px; background-color: #EBEBEB">
                    ...
                    {{ Form::open(array('action' => 'OptController@store', 'style' => 'padding: 40px', 'id' => 'regForm')) }}
                    <table width="621" height="500" border="0">
                        ...
                        <tr>
                            ...
                            <td width="333">
                                ...
                                '2' => 'operating', '3' => 'Cancelled', ], null, ['required' => 'true', 'id' => 'patient_id', 'style' => "width: 100%; height: 38px"] ); }}

                            </td>
                        </tr>
                        <tr>
                            <td width="272" height="55"><label>Operation Reason:</label> </td>
                            <td width="333" height="200">{{ Form::textarea('operation_reason', null, array('rows' => '7', 'cols' => '20', 'placeholder' => 'Enter Reason', "style" => "font-size: 1.2em; margin-top: 2px; resize: none; width: 98%") ) }}</td>
                        </tr>
