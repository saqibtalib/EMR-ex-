...
//      Send email to employee
    ...
    public function validate()
    {
        ...
        if (Auth::attempt(array('email' => $email, 'password' => $password), true))
        {
            ...
            else if(Auth::user()->status == 'Active' && Auth::user()->role == 'Nurse') {
                return Redirect::to('nurse_home');
            }
            else if(Auth::user()->status == 'Active' && Auth::user()->role == 'Pharmacy Manager'){
                return Redirect::to('pharmacy_home');
            }
