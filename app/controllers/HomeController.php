...
//////////////////////////////////////////nurse////////////////////////
    public function showNurse_home()
    {
        return View::make('nurse.layouts.nurse_home');
    }


    public function showNursePMR(){
        $UpdateHs = UpdateHs::all();
        return View::make('nurse.layouts.nursePmr', compact('UpdateHs'));
    }
    public function vwpatient()
    {
...
////////////////////////////nurse end///////////////////////////////////
    ...
    public function showPharmacy_home()
    {
        return View::make('pharmacy.pharmacy_home');
    }
